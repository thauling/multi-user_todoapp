    ...
    <div class="create">
        <form method="post" action="index.php">
            ...
            ?>
                ...
                <label for="title">Write a new title for your task:</label>
                <input type="text" name="title" value="<?php echo $row['title'] ?>" placeholder="Title for task" required />
                <label for="description">Write a description for your task:</label>
                <input type="text" name="description" value="<?php echo $row['description'] ?>" placeholder="Description for task" required />

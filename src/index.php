...
?>
    ...
    <div class="h-full w-full p-4 border-4 border-teal-400 bg-gray-100">
            <form class="flex flex-col content-center justify-items-center" method="post" action="index.php">
                ...
                <button class="bg-teal-700 text-gray-200 mt-2 w-56 text-center" type="submit" name="submit">Submit</button>
            </form>
    </div>
</body>
<?php
